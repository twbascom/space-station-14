...
heretic-ritual-fail-sacrifice-ineligible-count = The rune refuses to accept this sacrifice. It requires {$min} corpses, but you only have {$actual}.
...
heretic-ritual-fail-sacrifice-ash-count = There's either not enough of them dead, or burning. It requires {$min} burning corpses, but you only have {$actual}.
heretic-ritual-fail-sacrifice-blade = Some of them are still having a head on their shoulders.
heretic-ritual-fail-sacrifice-blade-count = Some of them are still having a head on their shoulders. It requires {$min} beheaded corpses, but you only have {$actual}.
heretic-ritual-fail-sacrifice-rust = Not enough rotting or silicon corpses.
heretic-ritual-fail-sacrifice-rust-count = Not enough rotting or silicon corpses. It requires {$min} rotting or silicon corpses, but you only have {$actual}.
heretic-ritual-fail-sacrifice-cosmos = Not enough star marked corpses.
heretic-ritual-fail-sacrifice-cosmos-count = Not enough star marked corpses. It requires {$min} star marked corpses, but you only have {$actual}.
